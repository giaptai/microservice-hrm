...
public record HoSoChiTietDTO(
        ...
        HoSoDTO.ResThongTinTuyenDung thongTinTuyenDung,
        HoSoDTO.ResQuanSu quanSu,
        int doiTuongChinhSach,
        HoSoDTO.ResHocVan hocVan,
        HoSoDTO.ResChucVu chucVu,
        int chucVuKiemNhiem,
        int chucVuDangHienTai,
        int chucVuDangKiemNhiem,
        double tienLuong,
        HoSoDTO.ResNgachNhanVien ngach,
        double phuCapChucVu,
        double phuCapKiemNhiem,
        double phuCapKhac,
        HoSoDTO.ResViecLam viecLam,
        HoSoDTO.ResSucKhoe sucKhoe,
