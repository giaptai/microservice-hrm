...
public class NgachNhanVien extends DateTimeObject {
    ...
    @Column(name = "ngach_cong_chuc", columnDefinition = "INTEGER")
    int ngachCongChuc;

    @Column(name = "ngach_vien_chuc", columnDefinition = "INTEGER")
    int ngachVienChuc;
    ...
    public NgachNhanVien(int ngachCongChuc, int ngachVienChuc, LocalDateTime ngayBoNhiemNgach,
                         LocalDateTime ngayHuongLuongNgach, float phanTramHuongLuongNgach, double phuCapThamNienVuotKhungNgach,
                         LocalDateTime ngayHuongPCTNVKNgach, HoSo hoSo) {
        super();
