...
public class ViecLam extends DateTimeObject {
    ...
    @OneToOne
    @MapsId
    @JoinColumn(foreignKey = @ForeignKey(name = "ho_so_vi_tri_viec_lam"), name = "ho_so_id", referencedColumnName = "id", columnDefinition = "binary(16)")
    HoSo hoSoId;

    public ViecLam(int viTriViecLam, LocalDateTime ngayHuongLuongTheoViTriViecLam,
                   float phamTramHuongLuong, double phuCapThamNienVuotKhung, LocalDateTime ngayHuongPCTNVK, HoSo hoSoId) {
        super();
