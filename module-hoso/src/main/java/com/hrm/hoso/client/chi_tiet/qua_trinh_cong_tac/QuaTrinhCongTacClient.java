...
public interface QuaTrinhCongTacClient {
    ...
    List<QuaTrinhCongTacAuth> getAllByHoSoId(@PathVariable UUID id);
    @GetMapping(value = "/qua-trinh-cong-tac")
    List<ResQuaTrinhCongTac> getAll();

    @GetMapping("/qua-trinh-cong-tac/{id}")
    ResQuaTrinhCongTac getById(@PathVariable int id);

    @PostMapping("/qua-trinh-cong-tac/{id}")
    ResQuaTrinhCongTac add(@PathVariable UUID id, @RequestBody ReqQuaTrinhCongTac cu);

    @PatchMapping("/qua-trinh-cong-tac/{id}")
    ResQuaTrinhCongTac edit(@PathVariable int id, @RequestBody ReqQuaTrinhCongTac cu);
