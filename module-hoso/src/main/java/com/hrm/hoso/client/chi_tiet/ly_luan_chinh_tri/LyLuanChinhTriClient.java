...
public interface LyLuanChinhTriClient {
    ...
    List<LyLuanChinhTriAuth> getAllByHoSoId(@PathVariable UUID id);
    @GetMapping(value = "/ly-luan-chinh-tri")
    List<ResLyLuanChinhTri> getAll();

    @GetMapping("/ly-luan-chinh-tri/{id}")
    ResLyLuanChinhTri getById(@PathVariable int id);

    @PostMapping("/ly-luan-chinh-tri/{id}")
    ResLyLuanChinhTri add(@PathVariable UUID id, @RequestBody ReqLyLuanChinhTri cu);

    @PatchMapping("/ly-luan-chinh-tri/{id}")
    ResLyLuanChinhTri edit(@PathVariable int id, @RequestBody ReqLyLuanChinhTri cu);
