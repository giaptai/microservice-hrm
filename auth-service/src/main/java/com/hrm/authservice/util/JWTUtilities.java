...
//        byte[] keyBytes = Base64.getDecoder().decode(secretStr.getBytes(StandardCharsets.UTF_8));
    ...
    public String generationToken(TaiKhoanDTO taiKhoanDTO) {
        Map<String, String> map = new HashMap<>();
        map.put("role", taiKhoanDTO.getRole());
        return Jwts.builder()
                .subject(taiKhoanDTO.getUsername())
                .claims(map)
...
//    }
    ...
    public boolean isTokenValid(String token, TaiKhoanDTO userDetails) {
