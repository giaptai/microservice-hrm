...
public class TinHocController {
    ...
    public ResponseEntity<ResTheDTO<ResTinHoc>> getAllByHoSoId(
        ...
        ResTheDTO<ResTinHoc> ls = tinHocService.xemDanhSachTheoHoSoId(id, xacNhan, byDate, pageNumber, pageSize);
        return new ResponseEntity<>(ls, ResEnum.THANH_CONG.getStatusCode());
    }

    @GetMapping("/tin-hoc")
    public ResponseEntity<ResTheDTO<ResTinHoc>> getAll(
            @RequestParam(name = "pheDuyet", required = false) XacNhan xacNhan,
            @RequestParam(name = "sort", required = false, defaultValue = "createAt") String byDate,
            @RequestParam(name = "page", required = false, defaultValue = "0") int pageNumber,
            @RequestParam(name = "size", required = false, defaultValue = "10") int pageSize) {
        ResTheDTO<ResTinHoc> ls = tinHocService.xemDanhSach(xacNhan, byDate, pageNumber, pageSize);
        return new ResponseEntity<>(ls, ResEnum.THANH_CONG.getStatusCode());
    }

    @GetMapping("/tin-hoc/{id}")
    public ResponseEntity<ResTinHoc> getById(@PathVariable(name = "id") int id) {
        ResTinHoc ls = tinHocService.xemChiTiet(id);
        return new ResponseEntity<>(ls, ResEnum.THANH_CONG.getStatusCode());
    }
    ...
    public ResponseEntity<ResTinHoc> add(@PathVariable(name = "id") UUID id, @RequestBody ReqTinHoc cu) {
        ResTinHoc ls = tinHocService.them(id, cu);
    ...
    public ResponseEntity<ResTinHoc> edit(
        ...
        ResTinHoc ls = tinHocService.sua(id, cu, role);
    ...
    public ResponseEntity<ResTheDTO<ResTinHoc>> getAllCaNhan(
            @RequestHeader(name = "taiKhoanId", required = false) int id,
            @RequestParam(name = "pheDuyet", required = false) XacNhan xacNhan,
            @RequestParam(name = "sort", required = false, defaultValue = "createAt") String byDate,
            @RequestParam(name = "page", required = false, defaultValue = "0") int pageNumber,
            @RequestParam(name = "size", required = false, defaultValue = "10") int pageSize) {
        ResTheDTO<ResTinHoc> ls = tinHocService.xemDanhSachCaNhan(id, xacNhan, byDate, pageNumber, pageSize);
        return new ResponseEntity<>(ls, ResEnum.THANH_CONG.getStatusCode());
    }
    ...
    public ResponseEntity<ResTinHoc> addCaNhan(@RequestHeader(name = "taiKhoanId", required = false) int id, @RequestBody ReqTinHoc cu) {
        ResTinHoc ls = tinHocService.themCaNhan(id, cu);
        return new ResponseEntity<>(ls, ResEnum.TAO_THANH_CONG.getStatusCode());
    }
